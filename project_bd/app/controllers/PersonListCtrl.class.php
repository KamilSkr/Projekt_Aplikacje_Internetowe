...
//        ------- zawodnik--------
        ...
        if (isset($this->form->surname) && strlen($this->form->surname) > 0) {
            $search_paramsz['surname[~]'] = $this->form->surname . '%'; // dodanie symbolu % zastępuje dowolny ciąg znaków na końcu
        }
...
//        ---------- sedzia ---------
        ...
        if (isset($this->form->surname) && strlen($this->form->surname) > 0) {
            $search_params_s['surname[~]'] = $this->form->surname . '%'; // dodanie symbolu % zastępuje dowolny ciąg znaków na końcu
        }
        ...
        try {
            $this->records = App::getDB()->select("trenerzy", [
                "id_trenera",
                "name",
                "surname",
                "age",
...
//        ----------- zawodnik ---------------
        ...
        try {
            $this->recordsz = App::getDB()->select("zawodnik", [
                "id_zawodnika",
                "name",
                "surname",
                "club",
...
//        --------------sedzia -------------
        ...
        try {
            $this->records_s = App::getDB()->select("sedzia", [
                "id_sedzia",
                "name",
                "surname",
                "age",
        ...
        App::getSmarty()->assign('trenerzy', $this->records);  // lista rekordów z bazy danych
        App::getSmarty()->assign('zawodnik', $this->recordsz);  // lista rekordów z bazy danych
        App::getSmarty()->assign('sedzia', $this->records_s);  // lista rekordów z bazy danych
